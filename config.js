...
global.ppulsa = '085857537269' //telkomsel
...
global.namebot = 'Gilzzあ-Botz'
global.nameown = 'Gilzzあ'

/*============== Github Thanks To ==============*/
global.namagithub = 'AgilzElite' // nama github lu
global.linkgithub = 'https://github.com/AgilzElite' // tarok link github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 Gilzz 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Gilzz ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Gilzzあ '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Gilzzあ`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 Gilzz  あ」'
